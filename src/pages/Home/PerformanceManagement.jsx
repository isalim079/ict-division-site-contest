        ...
        <div>
            <div className="max-w-screen-xl mx-auto px-2 md:px-0 mt-10 md:mt-0">
                <div className="md:flex justify-center gap-10 items-center ">
                    ...
                    <img className="w-12 md:w-20" src={performanceManagement} alt="" data-aos="fade-left" />
                        <h1 className="md:text-2xl font-black text-[#683091] border-2 border-[#683091] px-4 py-2 shadow-lg rounded-md" data-aos="fade-right">Annual Performance</h1>
                    </div>
