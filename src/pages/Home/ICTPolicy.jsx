        ...
        <div>
            <div className="max-w-screen-xl mx-auto px-2 lg:px-0 mt-10 lg:mt-0">
                <div className="lg:flex justify-center gap-10 items-center ">
                    ...
                    <img className="w-12 lg:w-20" src={ictPolicy} alt="" data-aos="fade-left" />
                        <h1 className="lg:text-2xl font-black text-[#683091] border-2 border-[#683091] px-4 py-2 shadow-lg rounded-md" data-aos="fade-right">ICT Policy</h1>
                    </div>
