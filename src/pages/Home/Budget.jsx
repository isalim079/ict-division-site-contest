        ...
        <div>
            <div className="max-w-screen-xl mx-auto mt-10 md:mt-36 px-2 md:px-0">
                ...
                <div className="md:flex justify-center gap-10 items-center">
                    ...
                    <img className="w-12 md:w-20" src={budget} alt="" data-aos="fade-left" />
                        <h1 className="md:text-2xl font-black text-[#683091] border-2 border-[#683091] px-4 py-2 shadow-lg rounded-md" data-aos="fade-right">Budget & Projects</h1>
                    </div>
