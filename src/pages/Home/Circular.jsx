...
const Circular = () => {
    ...
    return (
        <div>
            <div className="max-w-screen-xl mx-auto mt-10 lg:mt-0 px-2 lg:px-0">
                <div className="lg:flex justify-center gap-20 items-center">
                    <div className="flex flex-col items-center space-y-3 mb-5 lg:mb-0">
                    <img className="w-12 lg:w-20" src={circular} alt="" data-aos="fade-left" />
                        <h1 className="lg:text-2xl font-black text-[#683091] border-2 border-[#683091] px-4 py-2 shadow-lg rounded-md" data-aos="fade-right">Circular</h1>
                    </div>
